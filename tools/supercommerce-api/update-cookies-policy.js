/**
 * Function to update cookies policy.
 *
 * @param {Object} params - The parameters for update cookies policy.
...
const executeFunction = async (params) => {
  ...
  try {
    ...
    console.error('Error in updateCookiesPolicy:', error);
    return { error: error.message || 'An error occurred during the operation.' };
  }
};

/**
 * Tool configuration for update cookies policy.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    type: 'function',
    function: {
      name: 'update_cookies_policy',
      description: 'Update Cookies Policy',
      parameters: {
        type: 'object',
        properties: {
          slug: {
