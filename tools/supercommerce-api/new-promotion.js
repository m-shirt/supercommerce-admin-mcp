/**
 * Function to new promotion.
 *
 * @param {Object} params - The parameters for new promotion.
...
const executeFunction = async (params) => {
  ...
  try {
    ...
    const url = `${baseURL}/api/admin/promotions`;
    ...
    console.error('Error in newPromotion:', error);
    return { error: error.message || 'An error occurred during the operation.' };
  }
};

/**
 * Tool configuration for new promotion.
 * @type {Object}
 */
const apiTool = {
