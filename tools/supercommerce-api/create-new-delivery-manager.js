/**
 * Function to create new delivery manager.
 *
 * @param {Object} params - The parameters for create new delivery manager.
...
const executeFunction = async (params) => {
  ...
  try {
    ...
    console.error('Error in createNewDeliveryManager:', error);
    return { error: error.message || 'An error occurred during the operation.' };
  }
};

/**
 * Tool configuration for create new delivery manager.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    type: 'function',
    function: {
      name: 'create_new_delivery_manager',
      description: 'Create New Delivery Manager',
      parameters: {
        type: 'object',
        properties: {
          name: {
