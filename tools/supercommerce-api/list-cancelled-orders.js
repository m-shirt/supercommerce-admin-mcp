/**
 * Function to list cancelled orders.
 *
 * @param {Object} params - The parameters for list cancelled orders.
...
const executeFunction = async (params) => {
  ...
  try {
    ...
    console.error('Error in listCancelledOrders:', error);
    return { error: error.message || 'An error occurred during the operation.' };
  }
};

/**
 * Tool configuration for list cancelled orders.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    type: 'function',
    function: {
      name: 'list_cancelled_orders',
      description: 'List Cancelled Orders',
      parameters: {
        type: 'object',
        properties: {
          term: {
