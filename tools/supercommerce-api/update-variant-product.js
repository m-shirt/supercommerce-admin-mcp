/**
 * Function to update variant product.
 *
 * @param {Object} params - The parameters for update variant product.
...
const executeFunction = async (params) => {
  ...
  try {
    ...
    let url = `${baseURL}/api/admin/products/${id}/variants/${variant}`;
...
/**
 * Tool configuration for update variant product.
 * @type {Object}
 */
const apiTool = {
